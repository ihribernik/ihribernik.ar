export function CvButton() {
  ...
  return (
    <button
      ...
      className="fixed z-90 bottom-10 right-8 bg-yellow-600 w-20 h-20 rounded-full drop-shadow-lg flex justify-center items-center text-white text-4xl hover:bg-yellow-700 hover:drop-shadow-2xl hover:animate-bounce duration-300"
    >
      <svg
        fill="#ffffff"
        version="1.1"
